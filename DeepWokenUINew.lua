...
function library:CreateWatermark(name, position)
    ...
    local newWatermark = Instance.new("ScreenGui", game:GetService("StarterGui"));
    newWatermark.Name = 'Watermark';

    watermark.main = newWatermark:Clone()
    watermark.main.Parent = coregui
...
function library:CreateWindow(name, size, hidebutton)
    ...
    local windowNew = Instance.new("ScreenGui", game:GetService("StarterGui"))
    windowNew.Name = name
    
    window.Main = windowNew:Clone();
